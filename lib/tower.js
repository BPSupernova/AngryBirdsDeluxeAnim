...
class Tower {
    ...
    buildTower() {
        ...
        //create a hierarchical tower structure
    ...
    update(currentTime) {
        ...
        if (this.pigModel && this.pigModel.falling) {
            ...
            this.pigModel.position[0] = this.pigModel.originalPos[0] + this.pigModel.velocity[0] * deltaTime * 3;
            this.pigModel.position[1] = this.pigModel.originalPos[1] + this.pigModel.velocity[1] * deltaTime - 0.5 * G * deltaTime * deltaTime;
            this.pigModel.position[2] = this.pigModel.originalPos[2] + this.pigModel.velocity[2] * deltaTime * 3;
