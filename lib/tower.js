class Node {
    ...
    updatePhysics(currentTime) {
        ...
        if (worldPos[1] < 0) {
            console.log("Ground hit by block #", this.id);
    ...
    render() {
        ...
        this.setupBuffer('vPosition', vertices, 4);
        this.setupBuffer('vNormal', normals, 3);
        this.setupBuffer('vColor', colors, 4);
